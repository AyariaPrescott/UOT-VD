...
{
    /// <summary>
    /// 绿色神经元小球，绕彩色NeuronHalo旋转。样式与NeuronOne相似，但无护盾功能。
    /// 通过白色珍珠（DataPearl Misc）转换获得。
    /// </summary>
    public class NeuronThreeOne : UpdatableAndDeletable, IDrawable
    {
        ...
        public NeuronThreeOne(Player player)
        {
        ...
        public override void Update(bool eu)
        {
            ...
            {
                Plugin.Logger.LogError($"[UOT-VD] NeuronThreeOne.Update exception: {ex}");
            }
        }
        ...
        public void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            ...
            _sprite.alpha = 1f;
            _sprite.color = new Color(0.1f, 0.8f, 0.2f);  // 绿色
