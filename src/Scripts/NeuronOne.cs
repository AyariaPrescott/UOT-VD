...
{
    /// <summary>
    /// 黑色神经元小球，绕彩色NeuronHalo旋转。受伤时消耗以触发护盾。
    /// </summary>
    public class NeuronOne : UpdatableAndDeletable, IDrawable
    {
        ...
        private FSprite _oneSprite;

        public NeuronOne(Player player)
        {
        ...
        public override void Update(bool eu)
        {
            ...
            {
                Plugin.Logger.LogError($"[UOT-VD] NeuronOne.Update exception: {ex}");
            }
        }
        ...
        public void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            ...
            _oneSprite = new FSprite("Futile_White", true);
            _oneSprite.shader = rCam.game.rainWorld.Shaders["LightSource"];
            _oneSprite.scale = 14f / 16f;
            _oneSprite.alpha = 1f;
            _oneSprite.color = new Color(0.25f, 0.25f, 0.25f);
            sLeaser.sprites[0] = _oneSprite;
        ...
        public void DrawSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
        {
            ...
            _oneSprite.SetPosition(orbitPos);
            _oneSprite.color = new Color(0.25f, 0.25f, 0.25f);
            _oneSprite.scale = (13f + Mathf.Sin(angle * 2.3f) * 3f) / 16f;
            _oneSprite.alpha = 0.92f + Mathf.Sin(angle * 1.7f) * 0.08f;
